...
export default function Floating() {
  ...
  return (
    <>
      <FloatingButton anchorBottom anchorRight href="https://www.facebook.com/mayrajewelry.insaigon" target="_blank" className="drop-shadow-2xl shadow-2xl shadow-brand-500">
